              ...
              children: [
                {
                  ...
                  /* ─── уровень 4 под X-целью ─── */
                  children: [
                    {
                      id: 'g1kb', type: 'cmd',
                      name: 'Сбор и разметка базы знаний',
                      weight: '40%', pct: 70, owner: 'Команда 2', dept: 'IT', quarter: 'Q1 2026',
                      weightNum: '40', goalType: 'Количественная', isReverse: false,
                      strategicPriority: 'Не влияю на стратегический приоритет',
                      period: 'Q1, 2026',
                      planVal: '100', planUnit: '%', factVal: '70', factUnit: '%',
                      comment: 'Большая часть статей собрана, идёт вычитка.',
                      dos: ['Собрана и структурирована база знаний для обучения ассистента.'],
                      dod: ['Выгружены статьи из Confluence.', 'Удалены дубли и устаревшее.', 'Размечены категории.'],
                      /* ─── уровень 5 ─── */
                      children: [
                        {
                          id: 'g1kb1', type: 'cmd',
                          name: 'Подготовка обучающего датасета',
                          weight: '50%', pct: 80, owner: 'Команда 2', dept: 'IT', quarter: 'Q1 2026',
                          weightNum: '50', goalType: 'Количественная', isReverse: false,
                          strategicPriority: 'Не влияю на стратегический приоритет',
                          period: 'Q1, 2026',
                          planVal: '100', planUnit: '%', factVal: '80', factUnit: '%',
                          comment: 'Датасет сформирован, идёт балансировка классов.',
                          dos: ['Подготовлен размеченный датасет вопросов-ответов.'],
                          dod: ['Сформированы пары Q&A.', 'Проведена нормализация текста.', 'Разбит на train/val/test.'],
                          /* ─── уровень 6 ─── */
                          children: [
                            {
                              id: 'g1kb2', type: 'cmd',
                              name: 'Разметка эталонных диалогов',
                              weight: '60%', pct: 50, owner: 'Команда 4', dept: 'IT', quarter: 'Q1 2026',
                              weightNum: '60', goalType: 'Количественная', isReverse: false,
                              strategicPriority: 'Не влияю на стратегический приоритет',
                              period: 'Q1, 2026',
                              planVal: '100', planUnit: '%', factVal: '50', factUnit: '%',
                              comment: 'Размечена половина диалогов.',
                              dos: ['Размечены эталонные диалоги для оценки качества ответов.'],
                              dod: ['Описаны сценарии диалогов.', 'Проставлены эталонные ответы.', 'Согласовано с HR.'],
                              /* ─── уровень 7 ─── */
                              children: [
                                {
                                  id: 'g1kb3', type: 'cmd',
                                  name: 'Контроль качества разметки',
                                  weight: '100%', pct: 30, owner: 'Команда 4', dept: 'IT', quarter: 'Q1 2026',
                                  weightNum: '100', goalType: 'Количественная', isReverse: false,
                                  strategicPriority: 'Не влияю на стратегический приоритет',
                                  period: 'Q1, 2026',
                                  planVal: '100', planUnit: '%', factVal: '30', factUnit: '%',
                                  comment: 'Запущена кросс-проверка разметчиков.',
                                  dos: ['Подтверждено качество разметки эталонных диалогов.'],
                                  dod: ['Проведена кросс-проверка.', 'Посчитан inter-rater agreement.', 'Исправлены расхождения.'],
                                  children: [],
                                },
                              ],
                            },
